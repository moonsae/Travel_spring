...
import com.acorn.tour.mycourse.MycourseRepository;
...
public class MypageController {
    ...
    public String mypage(Model model) {
		...
		ArrayList<MycourseDTO> courselist = (ArrayList<MycourseDTO>) courseRep.getSelectMyCourse(userId);
    ...
    public String mypagecourse(Model model) {
		...
		String userId = (String)session.getAttribute("userId");
		ArrayList<MycourseDTO> list = (ArrayList<MycourseDTO>) courseRep.getSelectMyCourse(userId);
		...
		PageHandler handler = courseRep.getPaging(1, userId);
		model.addAttribute("handler" , handler);

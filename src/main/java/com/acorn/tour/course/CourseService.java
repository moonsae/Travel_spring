...
public class CourseService {
	...
	public ArrayList<CourseDTO> getSelectAllLatest(int startList, int endList, int sidoCode) {
		ArrayList<CourseDTO> list = (ArrayList<CourseDTO>) rep.selectAllLatest(startList, endList, sidoCode);
		return list;
	}
	
	// 인기순 content 10개씩 표출
	public ArrayList<CourseDTO> getSelectAllPopular(int startList, int endList, int sidoCode){
		ArrayList<CourseDTO> list = (ArrayList<CourseDTO>) rep.selectAllPopular(startList, endList, sidoCode);
		return list;
	}
	...
	public ArrayList<CourseContentDTO> getSelectCourse(String contentId) {
		ArrayList<CourseContentDTO> list = (ArrayList<CourseContentDTO>) rep.selectCourse(contentId);
